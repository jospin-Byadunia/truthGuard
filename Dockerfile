# 1. Lock Python to 3.10 slim (PaddlePaddle requirement)
FROM python:3.10-slim

EXPOSE 8000

# Keeps Python from generating .pyc files & enables unbuffered logging
...
# 5. Non-root user setup from VS Code template
RUN adduser -u 5678 --disabled-password --gecos "" appuser && chown -R appuser /app
USER appuser

# 6. Start server (matching your VS Code path: Backend.main:app)
